...
public class UserController {
    ...
    @GetMapping(value = "/{id}")
    public UserResponseDto getUser(@PathVariable Integer id) throws NoContentException {
    ...
    public UserResponseDto update(@PathVariable Integer id, @Validated(GroupUpdate.class) @RequestBody UserRequestDto user)
